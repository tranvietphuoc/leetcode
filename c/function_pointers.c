...
void func(int a) { printf("Value of a is %d\n", a); }
...
int main() {
    ...
    // 2. unlike normal pointers, we don't allocate de-allocate memory using
    // function pointers
    ...
    // 5. like normal data pointers, a function pointer can be passed as an
    // argument and can also be returned from a function for example:
    wrapper(func1);
    wrapper(func2);
    ...
    // 6. many object oriented features can be implemented using function
    // pointers
    return 0;
}
